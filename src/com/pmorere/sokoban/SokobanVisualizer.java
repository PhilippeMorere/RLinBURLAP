...
/**
 * Created by philippe on 2/16/15.
 */
...
public class SokobanVisualizer {
    ...
    public static StateRenderLayer getRenderLayer(int [][] map){
        ...
        r.addObjectClassPainter(SokobanDomain.CLASSLOCATION, new LocationPainter(map));
        r.addObjectClassPainter(SokobanDomain.CLASSAGENT, new CellPainter(1, Color.gray, map));
        r.addObjectClassPainter(SokobanDomain.CLASSROCK, new CellPainter(1, Color.black, map));
    ...
    public static class CellPainter implements ObjectPainter {
        ...
        public void paintObject(Graphics2D g2, State s, ObjectInstance ob, float cWidth, float cHeight) {
            ...
            float rx = ob.getDiscValForAttribute(SokobanDomain.ATTX)*width;
            float ry = cHeight - height - ob.getDiscValForAttribute(SokobanDomain.ATTY)*height;
    ...
    public static class LocationPainter implements ObjectPainter{
        ...
        public void paintObject(Graphics2D g2, State s, ObjectInstance ob, float cWidth, float cHeight) {
            ...
            int type = ob.getDiscValForAttribute(SokobanDomain.ATTLOCTYPE);
